...
aiPostboxOpen("id-help-browser", "Advanced iframe browser detection", $closedArray); 
?>
      <p>
    ...
    <a href="#" onclick="jQuery('#browser-help').show(); return false;" > <?php _e('Show me how to configure the browser detection in advanced iframe pro.') ?></a>
      ...
      <p>
         If the automatic update does not work you can get an updated version of the browsercap.ini lite file here: https://browscap.org/<br />Please use the light version as it conains all settings for the provided settings ! 
      </p>
      <p>
