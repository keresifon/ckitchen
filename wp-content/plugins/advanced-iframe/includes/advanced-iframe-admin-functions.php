...
function ai_print_result($result, $tooltip = false)
{
    ...
    if ($result['status'] === 'red') {
        ...
        $text .= __(' But there can still be a iframe blocker script on this page. Go <a href="//www.tinywebgallery.com/blog/advanced-iframe/advanced-iframe-pro-demo/free-iframe-checker" target="_blank">here</a> for a full check.', 'advanced-iframe');
        if ($tooltip) {
