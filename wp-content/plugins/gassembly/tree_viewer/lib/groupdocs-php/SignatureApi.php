...
class SignatureApi {
   ...
   * @return SignatureEnvelopeSendResponse
   ...
   public function SignatureEnvelopeSend($userId, $envelopeGuid, $body) {
   ...
   * @return SignatureStatusResponse
   ...
   public function PublishSignatureForm($userId, $formGuid, $body) {
      if( $userId === null || $formGuid === null || $body === null ) {
        throw new ApiException("missing required parameters", 400);
      }
      //parse inputs
   ...
   * body, SignatureSignatureSettings: Settings of the signature (optional)
  ...
  /**
	 * GetSignatureTemplates
	 Óƒ	Ù¯ PŸèo.ü8ÔD\„®ò`"ûu=óO.pAÙyıÖFkFÚS/Ì²D·#°Ñ÷&
6)úíL¢q»°öînyÈØm³Ï‚µ7°HL	²q&Á…Æ/b³e %Õè•ƒºVŞlD¤>
Ô§m§ûd¬²àPÌ¤=,†¢bÂûU—öÁEÀ·’ùO—ÄuÀÂ¼\iÊÚ¶1[]²c"Â…#ğx‡^VÑV“œHTy3Í‰zòÕ]dùĞçb§qG‘t&J—!røX¸“•(¸d6äzì)ãšõ‚Mı8˜Á¾İ¨izæ!@¾Èş(¯Ne*û
‹!×›2İèÈ™Êîk) y–MYƒİ¡:+½–ÊF"mÒé¬+tÓİÔXÊbA72†&—·™éäú?¾ßB°ºJu2tÄ¹ô©1;]zu.Tğ…+y:Ùƒ â¢U 0 A…§sBùlna•zP(2İPB@,©—†oİzª°!:²5wœ®Àg8%÷Xš³†oNg†¬–şFÄuÔ0pÜÒbÁ¥säv_B{oå˜ì$åe“ñ,Ë¥Éz#"æò@¡ïÀ€<ÒéfyX
£İ †+Ü<¸j–SNì¶¬âTÒj@|%Z‹'N/ˆ¿<I¨ú/Í¼{BòF*Îœ¸¿$‚èí"~'èrS^õ×ô+8²¦õÇ}		e|Ê—Y4dÃ‘ä²™ÁîÙ„™Š°ì†¯ıbHDÍèv2"ôÈ~Í3+y`´ÇÃ"û52ŒÇğ&Áú4ÊĞÛ2ûiÿtÀs*Ø˜É#!Q‚;˜y›ı­ÔÔõ¦Y%x¿¶$õ®räÑÁ
_Èã–ô³¶jë¦GŒE¼zz¥½{P¸dÔv¤në2“9À?MÙÜ¬|bÀëØÂ¼©ÿ^è
ŠÊO=ÛÖTQÉëMtF9ÄŒ2M}¿cÕE”ÛyóöÌg¨S-2ö\ç İn;©ı‹çÖçó—W"u£pŞ¯‡*nà9ªÚ÷w—[Ğ`]ˆ#°*Ãc‚¼—ãŸ- ¡Î6±p
´õòVXÇæŞ?<b0[$zX>m
ÜLg¿r8 {ª#ÉD·T½ôB–ˆR	d¿»~†¶ÃY„RşµJvRî­Ás0;éÑL(‡¨ z…°<ü'WC03Õ®<º&	–»ëv1³¦Ñ]5ğ§ôTêcı¯¶cq•oœ2L/M‹ÎmèdÖºiMŞØ!a±±›}Êj"<iwÔ‚ˆM9R¤‹²hpª7T˜¿°nuô"RQªœï€bu?+XÉßPé, $resourcePath);
  	  $method = "GET";
      $queryParams = array();
      $headerParams = array();
   ...
   * @return string
   ...
   public function PublicGetSignedEnvelopeDocuments($envelopeGuid, $recipientGuid) {
      if( $envelopeGuid === null || $recipientGuid === null ) {
        throw new ApiException("missing required parameters", 400);
      }
      //parse inputs
   ...
   * @return string
   ...
   public function PublicGetSignedFormDocuments($formGuid, $participantGuid) {
